...
export const AdvisoryHeadSchema = {
    type: 'object',
    required: ['uuid', 'identifier', 'document_id', 'issuer', 'published', 'withdrawn', 'title', 'labels'],
    properties: {
        document_id: {
            type: 'string',
...
export const AncestorSummarySchema = {
    type: 'object',
    required: ['sbom_id', 'node_id', 'purl', 'name', 'version', 'published', 'document_id', 'product_name', 'product_version', 'ancestors'],
    properties: {
        ancestors: {
            type: 'array',
            items: {
...
export const ClearlyDefinedPackageTypeSchema = {
    type: 'string',
    enum: ['composer', 'crate', 'deb', 'gem', 'git', 'go', 'maven', 'npm', 'nuget', 'pod', 'pypi']
} as const;
...
export const DepNodeSchema = {
    type: 'object',
    required: ['sbom_id', 'node_id', 'relationship', 'purl', 'name', 'version', 'deps'],
    properties: {
        deps: {
            type: 'array',
            items: {
...
export const DepSummarySchema = {
    type: 'object',
    required: ['sbom_id', 'node_id', 'purl', 'name', 'version', 'published', 'document_id', 'product_name', 'product_version', 'deps'],
    properties: {
        deps: {
            type: 'array',
            items: {
...
export const LicenseSummarySchema = {
    type: 'object',
    required: ['id', 'license', 'spdx_licenses', 'spdx_license_exceptions', 'purls'],
    properties: {
        id: {
            type: 'string'
        },
...
export const ProgressDetailsSchema = {
    type: 'object',
    required: ['current', 'total', 'percent', 'rate', 'estimatedSecondsRemaining', 'estimatedCompletion'],
    properties: {
        current: {
            type: 'integer',
            format: 'int32',
...
export const RelationshipSchema = {
    type: 'string',
    enum: ['contained_by', 'dependency_of', 'dev_dependency_of', 'optional_dependency_of', 'provided_dependency_of', 'test_dependency_of', 'runtime_dependency_of', 'example_of', 'generated_from', 'ancestor_of', 'variant_of', 'build_tool_of', 'dev_tool_of', 'described_by', 'package_of', 'undefined']
} as const;
...
export const SbomHeadSchema = {
    type: 'object',
    required: ['id', 'labels', 'data_licenses', 'published', 'authors', 'name', 'number_of_packages'],
    properties: {
        authors: {
            type: 'array',
            items: {
...
export const VulnerabilityHeadSchema = {
    type: 'object',
    required: ['normative', 'identifier', 'title', 'description', 'reserved', 'published', 'modified', 'withdrawn', 'discovered', 'released', 'cwes'],
    properties: {
        cwes: {
            type: 'array',
            items: {
